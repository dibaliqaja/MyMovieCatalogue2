...
public class TVShowData {
    ...
    public static ArrayList<TVShow> getListData(){
        ...
        for (String[] aData : data) {
            ...
            tvShow.setScore(aData[2]);
            tvShow.setLanguage(aData[3]);
            tvShow.setRuntime(aData[4]);
            tvShow.setPhoto(aData[5]);
            tvShow.setGenre(aData[6]);
            tvShow.setDate(aData[7]);
            tvShow.setCrew(aData[8]);
            list.add(tvShow);
        }
        return list;
    }
